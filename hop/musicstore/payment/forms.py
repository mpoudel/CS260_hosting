...
CARD_TYPES = ((0, 'American Express'), (1, 'Discover'),(2, 'Mastercard'), (3, 'Visa'))
...
class PaymentForm(forms.Form):
    ...
    def clean_card_number(self):
        ...
        if(selected_card_type == 'Discover' and re.match(r"^6(?:011|5[0-9]{2})[0-9]{12}$", value) is None):
            error = True
        if(selected_card_type == 'Mastercard' and re.search(r"^(?:5[1-5][0-9]{2}|222[1-9]|22[3-9][0-9]|2[3-6][0-9]{2}|27[01][0-9]|2720)[0-9]{12}$", value) is None):
            error = True
